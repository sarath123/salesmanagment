...
$nameErr = $emailErr = $addressErr = $passwordErr = $dobErr = $telErr = $locationErr="";
$name = $email = $address = $password = $dob = $tel = $sex =$date = $location= "";
    $f = $q =0;
...
function test_input($data) {
   ...
   return $data;
    ...
    if($f==7)
    {   
        $strSQL = "INSERT INTO user (NAME,ADDRESS,DOB,EMAIL,PHONE,PASSWORD,SEX,JOINDATE,POSITION,LOCATION) VALUES('$name','$address','$dob','$email','$tel','$password','$sex','$date','manager','$location')";
